...
state("GWT")
{
    // flips between 1 in game and 2 on loads. Inside GWT.exe
    int loadingNormal : 0x5BFCF28; 
    /* 0 in game & 112 while Fast Travelling as well as a couple specific cutscene - these cutscenes are now removed on purpose since this issue wasn't discovered 
    for a couple months. Inside GWT.exe */
    int loadingFT     : 0x5D78138;
    string300 CurTextString : 0x05DC1E58, 0xC0, 0X28, 0X0;
}
